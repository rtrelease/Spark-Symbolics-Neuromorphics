...
- +*owlready2* - Python library for integrating OWL Ontologies: https://pypi.org/project/owlready2/ - *pip install owlready2*
 ...
 - +*Anaconda-navigator* - [Anaconda Blog - Python on DGX Spark](https://www.anaconda.com/blog/python-nvidia-dgx-spark-first-impressions) - [ARM64 Full Anaconda](https://repo.anaconda.com/archive/Anaconda3-2025.12-1-Linux-aarch64.sh)
