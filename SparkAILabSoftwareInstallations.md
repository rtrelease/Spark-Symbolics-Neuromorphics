...
- *owlready2* - Python library for integrating OWL Ontologies: https://pypi.org/project/owlready2/ - *pip install owlready2*
 ...
 - *Jupyter* - part of JetPack 7 BSP - launched via DGX Desktop Application in Linux Apps,, Windows or Mac Apps - https://docs.nvidia.com/dgx/dgx-spark/dgx-dashboard.html
